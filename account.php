...
$_SESSION["accountdelusertype"]="student";
...
$q = "select * from student where student.user='".$uname."' limit 1";
    ...
    <div class="main">
        <div class="container">
            <div class="signup-content">
                <div class="signup-img" style="height:1200px;">
                    ...
                    <form method="POST" class="register-form" id="register-form" action="https://lbedugate.000webhostapp.com/phpupdate.php">
                        ...
                        <div class="form-submit">
                            ...
                            <input type="submit" value="update" class="submit" name="submit" id="submit" />
							  ...
							  <div class="form-group">
					<form method="POST"  id="register-form" action="https://lbedugate.000webhostapp.com/phpdelaccount.php">
								 
						<label for="delacc" style="text-align:center;"> befor you delete your account confirm your password first :</label>
						
                        <input type="text" name="delacc"class="a2"id="cnfdel"placeholder="confirm your password" required>
                        
                        <br>
                        <button type="submit" class="btndel" value="del" style="width:auto;" >Delete Account </button>
